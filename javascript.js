...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        var weatherConditionDiv = $("<h3>").addClass("weatherCondition text-dark demo-1 mr-2")
    ...
    $("#add-city").on("click", function () {
        ...
        $.ajax({
            ...
            for (let i = 0; i < listItems.length; i++) {
                ...
                listItem.attr("data-name", "<p>" + itemName + "</p><p> Date: " + date + '   Start Time: ' + time + "</p><p> Venue: " + venue)
